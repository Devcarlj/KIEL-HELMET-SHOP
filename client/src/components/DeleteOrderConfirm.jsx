...
const DeleteOrderConfirm = ({ close, onConfirm, loading, orderId }) => {
    return (
            ...
            <div className='bg-white max-w-md w-full rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200'>
                ...
                <div className='flex items-center justify-between p-4 border-b bg-rose-50/50'>
                    <div className='flex items-center gap-2'>
                        ...
                        <h1 className='font-bold text-neutral-800 text-lg'>Delete Order</h1>
                    </div>
                    <button
                        onClick={close}
                ...
                <div className='p-6 text-center'>
                    <p className='text-neutral-600 mb-6'>
                        Are you sure you want to permanently delete order <span className='font-bold text-neutral-800'>#{orderId}</span>? This action is irreversible.
                    </p>
