const orderReceiptTemplate = ({ name, orderId, products, totalAmount, subTotalAmount, shippingFee, paymentMethod, deliveryAddress, frontendUrl }) => {
    ...
    <div style="font-family: 'Poppins', 'Inter', 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 20px auto; background-color: #FDF5E6; padding: 40px; border: 1px solid #E66E33; border-radius: 20px; box-shadow: 0 10px 25px rgba(139, 34, 34, 0.08);">
        ...
        <div style="text-align: center; margin-bottom: 28px;">
            <div style="display: inline-block; background-color: #D1FAE5; border: 2px solid #10B981; border-radius: 50px; padding: 10px 20px; margin-bottom: 16px; white-space: nowrap;">
                <span style="font-size: 18px; vertical-align: middle;">🎉</span>
                <span style="font-size: 14px; font-weight: 800; color: #10B981; vertical-align: middle; margin-left: 4px; letter-spacing: 1px; text-transform: uppercase;">Order Confirmed</span>
            </div>
            <h2 style="color: #2D2926; font-size: 20px; font-weight: 700; margin: 0 0 8px 0;">Thank you for your order!</h2>
            <p style="color: #888; font-size: 14px; margin: 0;">We've received your order and it's being processed.</p>
        </div>
        ...
        <p style="color: #2D2926; font-size: 15px; line-height: 1.6; margin-bottom: 24px;">
            Your order <strong style="color: #8B2222;">${orderId}</strong> has been placed successfully. Below are your order details:
        </p>
        ...
        <div style="background-color: #F3EBDD; border-radius: 12px; padding: 20px 24px; margin-bottom: 24px;">
            <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                ...
                <tr>
                    <td style="padding: 6px 0; font-size: 13px; color: #888; text-transform: uppercase; letter-spacing: 1px; font-weight: 700;">Delivery Address</td>
        ...
        <p style="color: #2D2926; font-size: 14px; line-height: 1.6; text-align: center; margin-bottom: 24px;">
            We will notify you once your order has been shipped. If you have any questions, feel free to <a href="https://www.facebook.com/people/KIEL-Helmet-SHOP/100092575211604/" style="color: #8B2222; font-weight: 700; text-decoration: underline;">contact us here</a>.
        </p>
