const orderCancelledAdminTemplate = ({ customerName, customerEmail, orderId, products, totalAmount, reason, orderDbId, frontendUrl }) => {
    ...
    <div style="font-family: 'Poppins', 'Inter', 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 20px auto; background-color: #FDF5E6; padding: 40px; border: 1px solid #E66E33; border-radius: 20px; box-shadow: 0 10px 25px rgba(139, 34, 34, 0.08);">
        ...
        <div style="text-align: center; margin-bottom: 28px;">
            <div style="display: inline-block; background-color: #FEE2E2; border: 2px solid #EF4444; border-radius: 50px; padding: 10px 22px; margin-bottom: 16px; white-space: nowrap;">
                <span style="font-size: 18px; vertical-align: middle;">🚫</span>
                <span style="font-size: 14px; font-weight: 800; color: #EF4444; vertical-align: middle; margin-left: 5px; letter-spacing: 1px; text-transform: uppercase;">Order Cancelled</span>
            </div>
            <p style="color: #888; font-size: 14px; margin: 0;">A customer has cancelled their order</p>
        </div>

        <div style="background-color: #F3EBDD; border-radius: 12px; padding: 20px 24px; margin-bottom: 24px;">
            <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 6px 0; font-size: 13px; color: #888; text-transform: uppercase; letter-spacing: 1px; font-weight: 700;">Customer</td>
        ...
        <div style="background-color: #F3EBDD; border-radius: 12px; overflow: hidden; margin: 24px 0;">
            ...
            <div style="padding: 16px 20px; text-align: right; border-top: 2px solid #E66E33;">
                ...
                <span style="font-size: 20px; font-weight: 800; color: #EF4444; margin-left: 12px;">₱${Number(totalAmount).toLocaleString('en-PH', { minimumFractionDigits: 2 })}</span>
            </div>
        </div>

        <p style="color: #2D2926; font-size: 14px; line-height: 1.6; text-align: center; margin-bottom: 24px;">
            The product stock has been automatically restored. You can review this order in your admin dashboard.
        </p>
...
export default orderCancelledAdminTemplate;
